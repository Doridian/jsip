...
import {
  ...
  recomputeRoutes,
  removeRoute,
} from "../ethernet/ip/router.js";
import { IPNet } from "../ethernet/ip/subnet.js";
import {
  addDHCP,
  DHCPNegotiator,
  removeDHCP,
} from "../ethernet/ip/udp/dhcp/stack.js";
import {
  addDNSServerFor,
  clearDNSServersFor,
  removeDNSServerFor,
} from "../ethernet/ip/udp/dns/stack.js";
...
export abstract class Interface implements IInterface {
  ...
  private ip?: IPAddr;
  private readonly mac: MACAddr = MACAddr.random();
  ...
  public isLocalDest(ip: IPAddr): boolean {
    return this.ip?.equals(ip) || false;
  }
