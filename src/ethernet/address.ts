...
export const MAC_BROADCAST = MACAddr.fromByteArray([0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF]);
export const MAC_NULL = MACAddr.fromByteArray([0x00, 0x00, 0x00, 0x00, 0x00, 0x00]);
